#!/usr/bin/env python3
"""
Manual scraper runner for the Global Health Research Hub.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run publication scrapers for Health Research Hub"
    )
    parser.add_argument(
        "--who",
        action="store_true",
    ...
    print_separator()
    print("🏥 Global Health Research Hub - Scraper Runner")
